...
/**
 * This creates a new fast dynamic array object
*/
extern FastDynamicArray* fda_new_array();
 ...
 */
extern FDA_END_OBJECT fda_get(FastDynamicArray* array, uint32_t index);

/**
 * Sets a value to the array, using the index
*/
extern void  fda_set(FastDynamicArray* array, uint32_t index, FDA_END_OBJECT value);
...
*/
extern void  fda_push_back(FastDynamicArray* array, FDA_END_OBJECT value);

/**
 * Removes the array object from the memory.
*/
extern void  fda_free(FastDynamicArray* array);
# ifdef __cplusplus
}
# endif /* __cplusplus*/
#endif /* FAST_DYNAMIC_ARRAY */